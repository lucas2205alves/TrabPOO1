public class Relatorio {
    ...
    public void relatorioMensal(int valorGastos, int valorGanhos, Gasto [] gasto, Ganho[] ganho){
        ...
        System.out.println("Seu valor de gastos foi: " + somaGastos);
        System.out.println("Seu valor de ganhos foi: " + somaGanhos);
        double total = somaGanhos - somaGastos;
        System.out.println("O seu ganhos - gastos " + total);
